...
<div class="card">
    <div class="card-body">
        {!! Form::model($product, ['route' => ['admin.products.update', $product], 'files'=>true, 'enctype'=>'multipart/form-data','method' => 'put' ]) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <img src="/image/{{ $product->imagen }}" id="imagenSeleccionada" style="max-height: 300px">
                </div>
